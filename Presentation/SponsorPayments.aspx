                   ...
                   <div  style="border: thin solid #A6D9F4; width: 100%">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="height: 27px; text-align: left">
                                    <asp:TextBox ID="txtReceipNo" runat="server" MaxLength="20" Width="120px"></asp:TextBox>
                                </td>
                                <td colspan="1" style="height: 27px; text-align: left">
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="height: 25px; width: 389px;">
                                    <asp:TextBox ID="txtSpnName" runat="server" MaxLength="20" Width="142px"></asp:TextBox>
                                </td>
                                ...
                                <td colspan="1" style="width: 23px; height: 25px">
                                        ...
                                        <asp:TextBox ID="txtAllAmount" runat="server" MaxLength="20" Width="105px" Style="text-align: right"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 23px; height: 25px;">
                                        <asp:TextBox ID="txtPaymentDate" runat="server" MaxLength="10" Width="105px"></asp:TextBox>
                                </td>
                                <td style="width: 74px; height: 25px;">
                            ...
                            <tr>
                                ...
                                <td style="width: 23px; height: 26px">
                                        ...
                                        <asp:TextBox ID="txtchequeDate" runat="server" MaxLength="10" Width="105px"></asp:TextBox>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="1" style="width: 23px; height: 17px">
                                        ...
                                        <asp:TextBox ID="txtCheque" runat="server" MaxLength="20" Width="105px"></asp:TextBox>
                                </td>
