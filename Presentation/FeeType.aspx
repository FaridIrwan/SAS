                ...
                <td class="fields" style="width: 100%; height: 16px;">&nbsp;
                    <asp:DataGrid ID="dgFaculty" runat="server" AutoGenerateColumns="False" Width="100%" Style="vertical-align: top" 
                        ...
                        <HeaderStyle BackColor="#CDD7EE" CssClass="dgHeaderStyle" Font-Bold="True" Font-Italic="False"
                            Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" />
                        <Columns>
                            <asp:BoundColumn DataField="Faculty" HeaderText="Faculty" ItemStyle-Width="60%"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="GL Account" ItemStyle-Width="40%">
                                <ItemTemplate>
                                        <asp:TextBox ID="txtGLAcc" runat="server" Width="220px" AutoPostBack="true" OnTextChanged="txtGLAcc_TextChanged"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="CheckGLAcc" runat="server" Text="Check" CommandName="Check"/>&nbsp;&nbsp;
                ...
                <td class="fields" style="width: 100%; height: 16px;">&nbsp;
                    <asp:DataGrid ID="dgKolej" runat="server" AutoGenerateColumns="False" Width="100%" Style="vertical-align: top" 
                        ...
                        <HeaderStyle BackColor="#CDD7EE" CssClass="dgHeaderStyle" Font-Bold="True" Font-Italic="False"
                            Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" />
                        <Columns>
                            <asp:BoundColumn DataField="Kolej" HeaderText="Kolej" ItemStyle-Width="60%"></asp:BoundColumn>
                            <asp:TemplateColumn HeaderText="GL Account" ItemStyle-Width="40%">
                                <ItemTemplate>
                                        <asp:TextBox ID="txtGLAccKolej" runat="server" Width="220px" AutoPostBack="true" OnTextChanged="txtGLAccKolej_TextChanged"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="CheckGLAccKolej" runat="server" Text="Check" CommandName="Check"/>&nbsp;&nbsp;
