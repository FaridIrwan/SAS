    ...
    <script language="javascript" type="text/javascript">
       ...
       // }
        ...
        function CheckStudent() {
            ...
            if (hfProgramCount > 0 && hfStudentCount > 0) {
                var new_window = window.open('StudentFeetype.aspx', 'Hanodale', 'width=520,height=500,resizable=0');
                new_window.focus();
            }
            else if (hfProgramCount == 0) {
                document.getElementById("<%=lblMsg.ClientID%>").innerHTML = "Please select at least one program"
                return false;
            }
            else {
                                        ...
                                        <td style="height: 138px;">
                                            <table style="width: 50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 120px; height: 25px; vertical-align: top;">
                                                        <asp:Label ID="Label23" runat="server" Text="Description " Visible ="false"></asp:Label>
                                                    </td>
                                                    <td style="vertical-align: top; height: 25px">&nbsp;</td>
                                                    <td style="height: 25px; vertical-align: top;" colspan="4">
                                                        <asp:TextBox ID="txtDesc" runat="server" Height="20px" MaxLength="150"
                                                            Width="600px" Visible ="false"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </table>
                                            <table width="60%">
                                ...
                                <table style="width: 100%">
                                    <tr>
                                        <td width="100%" style="height: 261px">
                                            <asp:CheckBox ID="chkFeeType" runat="server" AutoPostBack="True" OnCheckedChanged="chkFeeType_CheckedChanged" Text="Select All" Visible="false" />
                                            <asp:DataGrid ID="dgFeeType" runat="server" AutoGenerateColumns="False" Width="100%"
                                                ...
                                                <Columns>
                                                    <asp:TemplateColumn HeaderText="Select" Visible ="false">
                                                        <ItemTemplate>
                                                            <asp:CheckBox ID="chkView" runat="server" AutoPostBack="true" Visible ="false" />
                                                        </ItemTemplate>
                                                    </asp:TemplateColumn>
